...
!  include '../parameterfiles/ics.param'
  ...
  character(len=*), parameter :: halofinds=cubepm_root//'checkpoints_halos'
...
!  character(len=*), parameter :: halofinds=cubepm_root//'/input/halofinds'
  ...
  integer, parameter :: num_massbin=1
  integer            :: cur_massbin
...
!  integer(4), parameter :: np_buffer=int(2./3.*max_np)
  ...
  integer(4), parameter :: max_np = np_node_dim*np_node_dim*(np_node_dim/100)
  integer(4), parameter :: np_buffer=int(2./3.*max_np)
